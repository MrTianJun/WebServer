...
const char* error_403_form = "You do not have permission to "
                             "get file from this server.\n";
...
void http_conn::init() {
    bytes_to_send = 0;   // bytes of ready to send
    bytes_have_send = 0; // bytes of have send
...
// 主状态机。解析HTTP请求,分析HTTP请求的入口函数
http_conn::HTTP_CODE http_conn::process_read()
{
    LINE_STATUS line_status = LINE_OK; // 记录当行的状态
